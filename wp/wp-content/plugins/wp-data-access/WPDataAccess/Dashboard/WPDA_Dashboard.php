...
class WPDA_Dashboard {
    ...
    protected function dashboard_default() {
        ...
        ?>?page=wpda_designer" title="Create database tables and indexes">
					...
					<div class="wpda-dashboard-group wpda-dashboard-group-apps">
						<div class="icons">
							<a class="wpda-dashboard-item wpda_tooltip_icons" href="<?php 
        echo admin_url( 'admin.php' );
        // phpcs:ignore WordPress.Security.EscapeOutput
        ?>?page=wpda_apps" title="App Builder

Build data driven Apps with
the new Table and Form Builders">
								<div class="fa-solid">
						...
						<div class="subject" style="color: red; font-weight: bold">NEW</div>
					</div>
    ...
    protected function toolbar_apps() {
        ?>
			<div id="wpda-dashboard-toolbar" class="wpda-dashboard-toolbar" style="display:none">
				...
				<div class="wpda-promotion" style="font-size: 16px">
					<span>
						<a href="https://wpdataaccess.com/2024/04/15/the-app-builder-wp-data-access-5-5/"
						   target="_blank"
						   class="wpda_tooltip"
						   title="Click to read introduction to apps"
						>
							<i class="fas fa-circle-info"></i>
						</a>
					</span>
